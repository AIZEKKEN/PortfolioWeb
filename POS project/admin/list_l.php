 ...
 <!-- Content Header (Page header) -->
    ...
    <div class="card card-orange">
            <div class="card-header ">
              <h3 class="card-title" style="color:aliceblue;">LIST IN STOCK</h3>
            </div>
            <br>
                                ...
                                <?php if($rs_prd['p_qty'] > 0){ ?>
                                  <center>  
                                        ...
                                        <?php echo barcode($rs_prd['p_id']);?>
                                          ...
                                          <a href="list_l.php?p_id=<?php echo $rs_prd['p_id'];?>&act=add" class="btn btn-success" target=""><i class="fa fa-shopping-cart"></i> Pick up</a>
                                          </center>
                                <?php } else { ?>
