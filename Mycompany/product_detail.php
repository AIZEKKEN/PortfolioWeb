    ...
    <div class="container bg-light p-2 my-2">
        ...
        <div class="card mx-auto d-block" style="width: 70%; max-width: 500px">
            ...
            <div class="card-body bg-info">
                ...
                <p class="card-text">Detail : <?= $row["p_detail"]; ?></p>
                <p class="card-text">Prices : <?= $row["p_price"]; ?></p>

            </div>
        </div>
        <br>
        <button type="button" class="btn btn-primary d-block m-auto" onclick="window.location.href='product_list_for_customer.php'">Back to product</button>
