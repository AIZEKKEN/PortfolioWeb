...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="http://localhost/demo/index.php">Ecs Mall</a>
		</div>
	</nav>
	...
	<div class="col-md-6 well">
		...
		<div class="col-md-8">
			...
			<div class="form-group">
				<h4 class="text-warning">*ใส่โค้ดเพื่อรับส่วนลด</h4>
				...
				<div id="result"></div>
				<br style="clear:both;"/>
				<button class="btn btn-primary" id="activate">ใช้โค้ด</button>
			</div>
			<div class="form-group">
